Rosetta.register('r-todoapp', function (tag) {
    ...
    __m.__t = function tmpl(tag, attrs, refs) {
        return tag.create('div', { 'class': tag.type }, tag.create('section', { 'id': 'todoapp' }, tag.create('header', { 'id': 'header' }, tag.create('h1', null, 'todos'), tag.create('input', {
            ...
            return arr;
        }))), tag.create('footer', { 'id': 'footer' }, tag.create('span', { 'id': 'todo-count' }, tag.create('strong', null)), tag.create('ul', { 'id': 'filters' }, tag.create('li', null, tag.create('a', {
            'class': 'selected',
            'href': '#/'
    ...
    function submitChange(e) {
        ...
        if (e.which === 13 && $newtodo.val()) {
            ...
            tag.update({ list: tag.attrs.list });
            $newtodo.val('');
        }
    }
});